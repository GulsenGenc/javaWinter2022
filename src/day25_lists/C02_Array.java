...
// verilen bir array'den istenen elementi(kac tane varsa) silip, kalanlari
        ...
        istenmeyenElementiSil(arr,istenmeyenEleman); //[3, 4, 2, 3, 5, 3, 8, 5, 2, 4]

        System.out.println(Arrays.toString(arr)); //[3, 4, 2, 3, 5, 7, 3, 8, 5, 2, 4]
        //methodumuz void oldugu için ,sadece yazdırmaya yarar.arr de kalıcı değişiklik yapmaz.,
